...
public class AllayCompanionModel<T extends PlayerCompanion> extends SinglePartEntityModel<T> implements ModelWithArms {

    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(Identifier.of(FamiliarFriends.MOD_ID, "allay_companion"), "main");
    ...
    public AllayCompanionModel(ModelPart root) {
    ...
    public void setAngles(T allayEntity, float f, float g, float h, float i, float j) {
