package net.deadlydiamond98.familiar_friends.client.screens.widgets;
...
import net.deadlydiamond98.familiar_friends.util.screen.TextFormatHelper;
...
public class CompanionIconButton extends ButtonWidget {
    ...
    public void renderTooltip(DrawContext context, TextRenderer textRenderer, int mouseX, int mouseY) {
        if (isHovered()) {
            ...
            String description = companion.getDescription(CompanionKeybindings.getKeyLang()).getString();
